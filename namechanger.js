...
var countries = {
  ...
  "不丹":["Bhutan",0],
  "玻利维亚":["Bolivia",0],
  "波斯尼亚和黑塞哥维那":["Bosnia and Herzegovina",0],
  "博茨瓦纳":["Botswana",0],
  "巴西":["Brazil",0],
  "英属维京群岛":["British Virgin Islands",0],
  "文莱":["Brunei",0],
  "保加利亚":["Bulgaria",0],
  "布基纳法索":["Burkina-faso",0],
  "布隆迪":["Burundi",0],
  "柬埔寨":["Cambodia",0],
  "喀麦隆":["Cameroon",0],
  "加拿大":["Canada",0],
  "佛得角":["Cape Verde",0],
  "开曼群岛":["Cayman Islands",0],
  "中非共和国":["Central African Republic",0],
  "乍得":["Chad",0],
  "智利":["Chile",0],
  "中国":["China",0],
  "哥伦比亚":["Colombia",0],
  "科摩罗":["Comoros",0],
  "刚果(布)":["Congo - Brazzaville",0],
  "刚果(金)":["Congo - Kinshasa",0],
  "哥斯达黎加":["Costa Rica",0],
  "克罗地亚":["Croatia",0],
  "塞浦路斯":["Cyprus",0],
  ...
  "多哥":["Togo",0],
  "汤加":["Tonga",0],
  "特立尼达和多巴哥":["Trinidad and Tobago",0],
  "突尼斯":["Tunisia",0],
  "土耳其":["Turkey",0],
  "土库曼斯坦":["Turkmenistan",0],
  "美属维尔京群岛":["U.S. Virgin Islands",0],
  "乌干达":["Uganda",0],
  "乌克兰":["Ukraine",0],
